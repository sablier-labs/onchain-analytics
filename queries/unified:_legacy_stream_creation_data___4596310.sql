...
SELECT
	'ethereum' AS chain,
	tokenAddress AS asset,
	0x0000000000000000000000000000000000000000 AS broker,
	true AS cancelable,
	...
	'legacy' AS contract,
	'v1.0' AS version,
	'linear' AS streamingCurve,
	  CASE
    WHEN tokenAddress in (
		...
		THEN cast(deposit AS DOUBLE) / 1e6
    WHEN tokenAddress in (
		...
		THEN cast(deposit AS DOUBLE) / 1e18
    ELSE 0

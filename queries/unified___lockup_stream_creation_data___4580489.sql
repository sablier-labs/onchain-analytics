...
SELECT
  ...
  CASE
    ...
    OR asset = 0xaf88d065e77c8cc2239327c5edb3a432268e5831 -- Arbitrum One USDC
		...
		OR asset = 0x6b175474e89094c44da98b954eedeac495271d0f -- Ethereum DAI
		OR asset = 0x8f3cf7ad23cd3cadbd9735aff958023239c6a063 -- Polygon POS DAI
		OR asset = 0xda10009cbd5d07dd0cecc66161fc93d7c9000da1 -- Arbitrum One DAI
		OR asset = 0xda10009cbd5d07dd0cecc66161fc93d7c9000da1 -- Optimism DAI
		OR asset = 0x1af3f329e8be154074d8769d1ffa4ee058b1dbc3 -- BNB DAI
		THEN 'true'
    ELSE 'false'
  END AS stablecoin,

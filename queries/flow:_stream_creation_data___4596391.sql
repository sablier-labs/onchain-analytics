...
SELECT
    ...
    CASE
        WHEN
            ...
            THEN cast(ratepersecond AS DOUBLE) / 1e6 -- 6 decimals
        WHEN
            token IN (
            ...
            THEN cast(ratepersecond AS DOUBLE) / 1e18 -- 18 decimals
        ELSE 0
...
SELECT
    ...
    END AS stablecoinratepersecond
FROM
    sablier_flow_v1_1_multichain.sablierflow_evt_createflowstream
